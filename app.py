...
st.sidebar.number_input('Coal usage (tonnes)', value=initial_data['Coal usage (tonnes)'], disabled=False)
st.sidebar.number_input('Diesel usage Litres', value=initial_data['Diesel usage Litres'], disabled=False)
